// Generated from /home/joao/Desktop/Compiladores/final/compiladores-1819-g15/grammar/RobotLang.g4 by ANTLR 4.7.1
...
public class RobotLangParser extends Parser {
	...
	public static final String[] ruleNames = {
		...
		"vartypes", "bool_comparator", "return_statement", "var_identifier", "number"
	};

	private static final String[] _LITERAL_NAMES = {
		null, "'('", "')'", "'['", "']'", null, null, null, null, "'\n'", null, 
		"'function'", "'while'", "'for'", "'break'", "'one of'", "'any of'", "'case'", 
		"'if'", "'else'", "'move'", "'stop'", "'print'", "'or'", "'and'", "'>='", 
	...
	private static final String[] _SYMBOLIC_NAMES = {
		...
		"END_FOR", "END_WHILE", "END_CHOOSE", "END_IF", "RETURN_WORD", "IN", "INTWORD", 
		"STRINGWORD", "REALWORD", "IMPORT_WORD", "TRUE", "FALSE", "IDENTIFIER", 
		"STRING", "REAL", "INTEGER", "ERROR"
	};
